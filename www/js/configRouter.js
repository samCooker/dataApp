...
$stateProvider
    ...
    .state('app',{//状态名称
        ...
        templateUrl: 'templates/menu.html',//html模版路径，也可以直接使用template:'<div>template...<div>'
        controller: 'menuController'//控制器名称
    })
    .state('app.oa',{// (app.xxx)xxx继承自app状态
        url: '/oa',  // 完整路径为 /app/oa
        cache:'false',//是否使用缓存，是否每次进入都保持原状态，不刷新
        views:{
            'oa':{// 对应<ion-nav-view name="newfordos"></ion-nav-view>的name属性
                templateUrl:'templates/modules/oa/docList.html',
